...
model = EntitySentenceTransformer("../eventsim_output/esbert-bert-base-nli-stsb-mean-tokens-ep2-b8-m2.0/")
...
def main():
    ...
    # torch.save(train_features, "train_sent_embeds.pt")
    ...
    torch.save(dev_features, "dev_sent_embeds.pt")
