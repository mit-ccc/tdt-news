...
parser.add_argument("--source_dir", type=str, default="../eventsim_output/esbert-bert-base-nli-stsb-mean-tokens-ep2-b8-m2.0-exp", help="dest dir")
...
model = EntitySentenceTransformer(args.source_dir)
