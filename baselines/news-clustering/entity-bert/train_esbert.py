...
def main():
    ...
    model_save_path = "../eventsim_output/esbert-{}-ep{}-b{}-m{}-exp".format(model_name, num_epochs, train_batch_size, triplet_margin)
    ...
    train_examples = random.sample(train_examples, 30)
