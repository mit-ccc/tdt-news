...
def main():
    ...
    # extract triplets
    offline_triplets = extract_triplets(train_dev_distance_mat, class2idx, idx2class)
    print("Finished extracting triplets...")
    
    with open(os.path.join(args.input_folder, "train_dev_offline_triplets.pickle"), 'wb') as handle:
