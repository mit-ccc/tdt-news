...
#         test_corpus = pickle.load(handle)
    ...
    # initialize a model
    # entity_transformer = EntityTransformer("/mas/u/hjian42/tdt-twitter/baselines/news-clustering/entity-bert/pretrained/0_Transformer/")
    # entity_transformer.max_seq_length = max_seq_length
...
#     train_trip_examples = triplets_from_labeled_dataset(train_examples)
    ...
    folder_name = "output/{}_ep{}_mgn{}_btch{}_norm{}_max_seq_{}".format("exp_sbert", num_epochs, margin, train_batch_size, max_grad_norm, args.max_seq_length)
...
#             evaluation_steps=math.ceil(len(train_examples)/train_batch_size),
