...
do
    ...
    do
        for c2 in 0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.45 0.5
        # for c2 in 0.1 0.5 1.0 10 100
        # for c2 in 0.00001 0.00005 0.0001 0.0005 0.001 0.005 0.01 0.05 0.1 0.5 1.0 10 100
        do
            # SVM-rank-BERT + md_3
            ...
            do
                ...
                # BERT 
                # (NOT WORKING WITHOUT a BIAS)
                # python testbench.py --weight_model_dir ${input_folder}/models/weight_model_svm_triplet_tfidf_bert_c${c1}_lr${lr}_ep30.dat \
                # --merge_model_dir ${input_folder}/models/merge_model_tfidf_bert_smote_c${c2}_b0.md \
                # --output_filename ${input_folder}/predictions/svmtriplet_svmlib_tfidf_bert_smote_b0_weightM_c${c1}_lr${lr}_ep30_mergeM_c${c2}
