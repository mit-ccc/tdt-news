...
class learned_pos2vec_model(nn.Module):
    def __init__(self, model_path=None):
        super(learned_pos2vec_model, self).__init__()
...
#         test_corpus = pickle.load(handle)
    ...
    time_position_model = learned_pos2vec_model(model_path=None)
    ...
    folder_name = "output/{}_ep{}_mgn{}_btch{}_norm{}_max_seq_{}_fuse_{}_{}_sample_{}".format("exp_learned_pos2vec_esbert", num_epochs, margin, train_batch_size, max_grad_norm, args.max_seq_length, args.fuse_method, args.sample_method, args.loss_function)
