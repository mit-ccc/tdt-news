...
with open('/mas/u/hjian42/tdt-twitter/baselines/T-ESBERT/news_data/train_dev.pickle', 'rb') as handle:
...
with open('../news_data/train_dev_entity.pickle', 'wb') as handle:
